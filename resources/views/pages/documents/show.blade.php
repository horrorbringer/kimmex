        ...
        <div class="max-w-[1240px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 py-20 relative">
            ...
            <div class="lg:col-span-10 lg:col-start-2 xl:col-span-8 xl:col-start-3 space-y-16">
                ...
                @if($doc['fileUrl'])
                    ...
                    <div class="reveal-up mt-12 p-10 rounded bg-titan-navy flex flex-col items-center justify-center gap-8 relative overflow-hidden group">
                        ...
                        <a href="{{ Storage::url($doc['fileUrl']) }}" download target="_blank"
                            class="relative z-10 shrink-0 inline-flex items-center gap-3 bg-titan-red border border-titan-red/20 hover:bg-white hover:text-titan-navy text-white px-10 py-5 rounded font-black text-sm uppercase tracking-widest transition-all duration-300 shadow-xl hover:shadow-titan-red/20 group/dl">
            ...
            <aside class="lg:col-span-3 space-y-12">
                <div class="sticky top-32 space-y-12">
                    ...
                    <div class="reveal-up space-y-6">
                        ...
                        <div class="rounded overflow-hidden border border-gray-100 shadow-2xl aspect-[3/4] bg-gray-50 relative group flex items-center justify-center">
                            @if($doc['thumbnailUrl'])
                    ...
                    <!-- Small Info Box -->
                    <div class="reveal-up p-6 bg-gray-50 rounded border border-gray-100 space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        @foreach($relatedDocs as $rel)
                            ...
                            <a href="/documents/{{ $rel['slug'] }}"
                                class="group flex items-start gap-5 p-6 bg-white rounded border border-gray-100 hover:border-titan-red/20 hover:shadow-md transition-all duration-300">
                                <div
                                    class="w-14 h-14 rounded overflow-hidden shrink-0 bg-gray-50 flex items-center justify-center relative">
                                    @if($rel['thumbnailUrl'])
