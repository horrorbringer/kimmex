...
@if(!$job)
    <div class="py-40 text-center bg-gray-50 min-h-screen">
         <div class="max-w-[1200px] mx-auto px-6">
            ...
            <a href="{{ route('careers') }}" class="inline-block bg-titan-navy text-white px-8 py-4 rounded-sm font-bold text-xs uppercase tracking-widest hover:bg-titan-red transition-all">
        ...
        <section class="py-24 max-w-[1200px] mx-auto px-6">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-16">
                ...
                <div class="lg:col-span-8">
                    ...
                    <!-- 05: Application Form (Aligned with Backend) -->
                    <section id="apply-form" class="pt-16 border-t border-gray-100 mt-20">
                        <div class="bg-white rounded-sm p-8 md:p-12 border border-gray-100 shadow-sm transition-all">
                            ...
                            @if(session('success'))
                                <div class="bg-green-50 text-green-700 p-6 rounded-sm mb-10 text-xs font-bold border border-green-100 flex items-center gap-3 animate-fade-in-up">
                            ...
                            <form action="{{ route('careers.apply') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="space-y-2">
                                        ...
                                        <input type="text" name="full_name" value="{{ old('full_name') }}" required placeholder="{{ __('Enter your full name') }}" class="w-full bg-gray-50/50 border border-gray-100 rounded-sm px-5 py-4 text-sm font-semibold text-titan-navy outline-none focus:bg-white focus:ring-1 focus:ring-titan-navy/10 transition-all placeholder:text-gray-300 @error('full_name') border-titan-red @enderror" />
                                    </div>
                                    <div class="space-y-2">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="space-y-2">
                                        ...
                                        <input type="tel" name="phone" value="{{ old('phone') }}" required placeholder="+855 12 345 678" class="w-full bg-gray-50/50 border border-gray-100 rounded-sm px-5 py-4 text-sm font-semibold text-titan-navy outline-none focus:bg-white focus:ring-1 focus:ring-titan-navy/10 transition-all placeholder:text-gray-300 @error('phone') border-titan-red @enderror" />
                                    </div>
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative w-full h-[54px]" x-data="{ fileName: '' }">
                                            ...
                                            <div class="w-full h-full bg-gray-50/50 border border-gray-100 rounded-sm px-5 py-4 flex items-center justify-between text-titan-navy/30 group-hover:border-titan-navy/20 transition-all overflow-hidden @error('resume') border-titan-red @enderror">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <textarea name="message" rows="4" placeholder="{{ __('Briefly introduce yourself and why you are interested in this role...') }}" class="w-full bg-gray-50/50 border border-gray-100 rounded-sm px-5 py-4 text-sm font-semibold text-titan-navy outline-none focus:bg-white focus:ring-1 focus:ring-titan-navy/10 transition-all resize-none placeholder:text-gray-300"></textarea>
                                </div>

                                <div class="pt-4">
                                    <button type="submit" class="w-full bg-titan-navy text-white py-5 rounded-sm font-black text-[13px] uppercase tracking-widest hover:bg-titan-red transition-all shadow-xl shadow-titan-navy/10 flex items-center justify-center gap-4 group">
                ...
                <div class="lg:col-span-4 lg:sticky lg:top-[120px] h-fit space-y-8">
                    ...
                    <!-- Quick Apply Box -->
                    <div class="p-8 rounded-sm bg-white border border-gray-100 shadow-sm relative overflow-hidden group">
                        ...
                        <a href="#apply-form" class="w-full bg-titan-navy text-white py-5 rounded-sm font-black text-[13px] uppercase tracking-widest hover:bg-titan-red transition-all flex items-center justify-center gap-4 shadow-xl shadow-titan-navy/5 mb-4 px-6 border border-titan-navy">
                            {{ __('Jump to Form') }}
                    ...
                    <!-- Share Role -->
                    <div class="p-8 border border-gray-100 rounded-sm space-y-6 bg-white shadow-sm">
                         <h4 class="text-[10px] font-black text-titan-navy/30 uppercase tracking-[0.2em]">{{ __('Share this role') }}</h4>
                          <div class="flex gap-3">
                             <a href="javascript:void(0)" onclick="navigator.clipboard.writeText(window.location.href); alert('{{ __('Link copied to clipboard!') }}')" 
                                 class="w-10 h-10 rounded-sm bg-gray-100 flex items-center justify-center text-titan-navy hover:bg-titan-navy hover:text-white transition-all shadow-lg shadow-gray-200">
                             ...
                             <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url()->current()) }}" target="_blank" rel="noopener"
                                 class="w-10 h-10 rounded-sm bg-social-facebook flex items-center justify-center text-white hover:brightness-110 transition-all shadow-lg shadow-social-facebook/20">
                              ...
                              <a href="https://www.linkedin.com/sharing/share-offsite/?url={{ urlencode(url()->current()) }}" target="_blank" rel="noopener"
                                 class="w-10 h-10 rounded-sm bg-social-linkedin flex items-center justify-center text-white hover:brightness-110 transition-all shadow-lg shadow-social-linkedin/20">
                    ...
                    <!-- Quick Info -->
                    <div class="p-8 border border-gray-100 rounded-sm bg-gray-50/50">
