    ...
    <div class="bg-white min-h-screen text-titan-navy" x-data="{
            ...
            <section class="relative -mt-16 z-30 px-6 pb-32">
                <div class="max-w-[1400px] mx-auto">
                    <a href="/news/{{ $featured['slug'] }}"
                        class="group block bg-white rounded overflow-hidden shadow-[0_60px_120px_-20px_rgba(0,0,0,0.18)] border border-gray-100 transition-all duration-700 hover:-translate-y-3">
                        <div class="flex flex-col lg:flex-row min-h-[550px]">
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-5">
                                    <div
                                        class="w-14 h-14 rounded-full bg-gray-50 border border-gray-100 flex items-center justify-center text-titan-navy group-hover:border-titan-red group-hover:bg-titan-red/5 transition-all duration-500 shadow-sm">
                                        <x-lucide-arrow-right
                                            class="w-6 h-6 text-titan-red transition-transform group-hover:translate-x-1" />
                                    </div>
        ...
        <section class="sticky top-0 z-50 bg-white border-b border-gray-100 px-6">
            <div class="max-w-[1400px] mx-auto h-20 flex items-center justify-between">
                ...
                <div class="hidden lg:flex items-center gap-6 border-l border-gray-100 pl-8 ml-8">
                    ...
                    <div class="flex items-center gap-3 bg-gray-50 px-4 py-2 rounded border border-gray-100">
        ...
        <section class="max-w-[1240px] mx-auto px-6 py-16 lg:py-24">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                <template x-for="(article, index) in filteredArticles" :key="article.slug">
                    ...
                    <a :href="'/news/' + article.slug"
                        class="group flex flex-col bg-white border border-gray-100 hover:border-titan-red/10 transition-all duration-500 overflow-hidden transform hover:-translate-y-2 rounded shadow-sm hover:shadow-xl">
                        ...
                        <div class="p-8 flex-1 flex flex-col">
                            ...
                            <div class="mt-auto pt-6 border-t border-gray-50 flex items-center justify-between">
                                ...
                                <div
                                    class="w-9 h-9 border border-gray-100 flex items-center justify-center text-titan-red group-hover:border-titan-red group-hover:bg-titan-red/5 transition-all rounded-full">
                                    <x-lucide-arrow-right
            ...
            <div x-show="filteredArticles.length === 0"
                class="py-24 text-center bg-white border-2 border-dashed border-gray-100 rounded">
