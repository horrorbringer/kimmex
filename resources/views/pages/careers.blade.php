                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('careers.apply') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                        ...
                        <div class="flex items-center justify-between pt-2">
                            ...
                            <button type="submit"
                                class="inline-flex items-center gap-2 h-11 px-6 rounded-xl text-sm font-bold transition-all duration-300 group"
                                style="background: var(--primary-color, #E31E24); color: #FFFFFF;">
                                {{ __('Submit Application') }}
                                <x-lucide-arrow-right class="w-4 h-4 group-hover:translate-x-0.5 transition-transform" />
                            </button>
                        </div>
                    </form>
                </div>
