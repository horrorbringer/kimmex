<x-layouts.app :title="'Service Details'" :description="'Detailed information about Kimmex construction services.'">
    ...
    <div class="bg-white min-h-screen text-titan-navy">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                ...
                <div x-data="{ shown: false }" x-intersect.once="shown = true"
                    ...
                    <div class="relative group">
                        <div
                            class="absolute -inset-4 bg-titan-red/5 rounded-[2rem] rotate-2 group-hover:rotate-1 transition-transform duration-500">
                        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                @foreach($valueProp as $i => $benefit)
                    <div x-data="{ shown: false }" x-intersect.once="shown = true"
                        ...
                        <div
                            class="w-16 h-16 bg-titan-navy/5 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-titan-red group-hover:text-white transition-all duration-300">
        ...
        <section class="py-24 bg-white text-center px-6">
            <div
                class="max-w-3xl mx-auto bg-titan-red rounded-3xl p-12 md:p-16 shadow-2xl shadow-titan-red/30 relative overflow-hidden">
                <div
