...
<section class="py-20 md:py-28 bg-gray-50">
    <div class="max-w-[1280px] mx-auto px-6">
        ...
        <div x-data="{ shown: false }" x-intersect.once="shown = true"
            ...
            class="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14 transition-all duration-1000">
            <div>
                <div class="flex items-center gap-3 mb-4">
                    <div class="w-10 h-[2px]" style="background: var(--primary-color, #E31E24);"></div>
                    <span class="font-bold uppercase tracking-[0.2em] text-xs" style="color: var(--primary-color, #E31E24);">{{ __('Our Services') }}</span>
                </div>
