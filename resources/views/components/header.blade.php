            ...
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex items-center gap-2 sm:gap-3">
                    ...
                    <button @click="$dispatch('toggle-dark-mode')"
                        ...
                        class="dark-mode-toggle hidden lg:flex hover:bg-titan-red hover:text-white transition-all"
                        :aria-label="$root.classList.contains('dark') ? 'Switch to light mode' : 'Switch to dark mode'"
                        title="Toggle dark mode">
                        {{-- Sun icon (shown in dark mode) --}}
                        <svg x-cloak x-show="$root.classList.contains('dark')" xmlns="http://www.w3.org/2000/svg" class="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>
                        {{-- Moon icon (shown in light mode) --}}
                        <svg x-show="!$root.classList.contains('dark')" xmlns="http://www.w3.org/2000/svg" class="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>
                    </button>
    ...
    <div x-show="isMobileMenuOpen" x-collapse style="display: none;"
        ...
        <div class="max-h-[70vh] overflow-y-auto w-full">
            ...
            <div class="p-4 bg-gray-50 border-t border-gray-100">
                ...
                <div class="mt-3">
                    <button @click="$dispatch('toggle-dark-mode')"
                        class="w-full py-2 rounded text-xs font-bold transition-all border text-center flex items-center justify-center gap-2"
                        :class="$root.classList.contains('dark') ? 'bg-titan-navy text-white border-titan-navy' : 'bg-white text-titan-navy border-gray-200'">
                        <svg x-cloak x-show="$root.classList.contains('dark')" xmlns="http://www.w3.org/2000/svg" class="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>
                        <svg x-show="!$root.classList.contains('dark')" xmlns="http://www.w3.org/2000/svg" class="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>
                        <span x-text="$root.classList.contains('dark') ? '{{ __("Light Mode") }}' : '{{ __("Dark Mode") }}'"></span>
                    </button>
                </div>
            </div>
        </div>
