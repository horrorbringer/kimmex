...
class QueueMonitorWidget extends Widget
{
    ...
    public function getQueueStats(): array
    {
        ...
        $oldestAge = $oldestJob ? now()->diffForHumans(\Carbon\Carbon::createFromTimestamp($oldestJob), short: true) : null;
        ...
        $recentFailed = DB::table('failed_jobs')
            ...
            ->map(function ($job) {
                ...
                return [
                    ...
                    'failed_at' => \Carbon\Carbon::parse($job->failed_at)->diffForHumans(short: true),
                    'error' => \Illuminate\Support\Str::limit(explode("\n", $job->exception)[0] ?? '', 60),
                ];
            })->toArray();
